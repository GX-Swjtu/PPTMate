...
import { TONE_LABELS, VERBOSITY_LABELS } from '../labels';
                    ...
                    >
                        ...
                        <div className="overflow-hidden rounded-[24px] border border-[#E7E9F2] bg-[#F3F3F6] shadow-[0_24px_80px_rgba(15,23,42,0.20)]">
                                ...
                                <div className="flex items-start gap-2">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <Textarea
                                            ...
                                            placeholder="告诉 AI 目标受众、语气、重点或其他限制。"
                            ...
                            <div className="space-y-4 px-6 pb-5 pt-3.5 min-[1800px]:space-y-5 min-[1800px]:px-8 min-[1800px]:pb-7 min-[1800px]:pt-5">
                                ...
                                <div className="flex items-center justify-between gap-3">
                                    <label className="font-syne text-sm font-semibold leading-none text-[#1F1D2A] min-[1800px]:text-base">内容详细程度</label>
                                    <Select
                                ...
                                <div className="flex items-center justify-between gap-3">
                                    <label className="font-syne text-sm font-semibold leading-none text-[#1F1D2A] min-[1800px]:text-base">包含标题页</label>
                                    <Switch
